...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'more.shareSubtitle': 'Share Attenary with others',
    ...
    'more.groupGeneral': 'General',
    'more.groupData': 'Data',
    'more.groupReports': 'Reports',
    'more.groupSupport': 'Support',
    'hourRate.title': 'Hour Rate',
    'hourRate.subtitle': 'Track your earnings by hour',
    'hourRate.setRate': 'Hourly Rate',
    'hourRate.selectPeriod': 'Select Period',
    'hourRate.year': 'Year',
    'hourRate.month': 'Month',
    'hourRate.totalHours': 'Total Hours',
    'hourRate.earnings': 'Earnings',
    'hourRate.sessions': 'Sessions',
    'hourRate.daysWorked': 'Days Worked',
    'hourRate.dailyBreakdown': 'Daily Breakdown',
    'hourRate.noData': 'No data for this period',
    'hourRate.noCompletedSessions': 'No checked-out sessions found for this month.',
    'hourRate.invalidRate': 'Please enter a valid hourly rate.',
    'hourRate.saved': 'Hourly rate saved.',
    'hourRate.tapToEdit': 'Tap to edit rate',
    ...
    'bossExport.shareTitle': 'Share Report',
    'bossExport.shareSubtitlePdf': 'Choose how to share the PDF',
    'bossExport.shareSubtitleExcel': 'Choose how to share the Excel file',
    'bossExport.saveLocal': 'Save Locally',
    'bossExport.moreOptions': 'More Options',
    'bossExport.whatsapp': 'WhatsApp',
    'bossExport.telegram': 'Telegram',
    'bossExport.gmail': 'Gmail',
    'bossExport.generateFailedPdf': 'Failed to generate PDF. Please try again.',
    'bossExport.generateFailedExcel': 'Failed to generate Excel. Please try again.',
    'bossExport.savedPdf': 'PDF saved to your device.',
    'bossExport.savedExcel': 'Excel saved to your device.',
    'bossExport.sectionDaily': 'Daily Breakdown',
    'bossExport.sectionSession': 'Session Details',
    'bossExport.sharingNotAvailable': 'Sharing not available',
    'bossExport.sharingNotAvailableDevice': 'Sharing is not available on this device.',
...
'backup.size': 'Size',
    ...
    'backup.encryptionType': 'Security',
    'backup.encryption': 'Storage Level',
    'backup.encryptionValue': 'OS-Managed',
    ...
    'feedbacks.successBanner': 'Feedback sent successfully!',
    ...
    'feedbacks.minLengthHint': 'Min. 10 characters',
    ...
    'feedbacks.selectType': 'Select Type',
    'feedbacks.general': 'General',
    'feedbacks.generalDesc': 'General feedback, suggestions, or comments about your experience',
    'feedbacks.bugReport': 'Bug Report',
    'feedbacks.bugDesc': 'Report a bug or unexpected behavior you encountered',
    'feedbacks.featureRequest': 'Feature Request',
    'feedbacks.featureDesc': 'Suggest a new feature or improvement you\'d like to see',
  ...
  ar: {
    ...
    'more.shareSubtitle': 'مشاركة Attenary مع الآخرين',
    ...
    'more.groupGeneral': 'عام',
    'more.groupData': 'البيانات',
    'more.groupReports': 'التقارير',
    'more.groupSupport': 'الدعم',
    'hourRate.title': 'سعر الساعة',
    'hourRate.subtitle': 'تتبع أرباحك حسب الساعة',
    'hourRate.setRate': 'سعر الساعة',
    'hourRate.selectPeriod': 'اختر الفترة',
    'hourRate.year': 'السنة',
    'hourRate.month': 'الشهر',
    'hourRate.totalHours': 'إجمالي الساعات',
    'hourRate.earnings': 'الأرباح',
    'hourRate.sessions': 'الجلسات',
    'hourRate.daysWorked': 'أيام العمل',
    'hourRate.dailyBreakdown': 'التفصيل اليومي',
    'hourRate.noData': 'لا توجد بيانات لهذه الفترة',
    'hourRate.noCompletedSessions': 'لا توجد جلسات مكتملة لهذا الشهر.',
    'hourRate.invalidRate': 'الرجاء إدخال سعر ساعة صحيح.',
    'hourRate.saved': 'تم حفظ سعر الساعة.',
    'hourRate.tapToEdit': 'انقر لتعديل السعر',
    ...
    'bossExport.shareTitle': 'مشاركة التقرير',
    'bossExport.shareSubtitlePdf': 'اختر طريقة مشاركة PDF',
    'bossExport.shareSubtitleExcel': 'اختر طريقة مشاركة ملف Excel',
    'bossExport.saveLocal': 'حفظ محلياً',
    'bossExport.moreOptions': 'خيارات إضافية',
    'bossExport.whatsapp': 'واتساب',
    'bossExport.telegram': 'تيليجرام',
    'bossExport.gmail': 'Gmail',
    'bossExport.generateFailedPdf': 'فشل إنشاء PDF. يرجى المحاولة مرة أخرى.',
    'bossExport.generateFailedExcel': 'فشل إنشاء Excel. يرجى المحاولة مرة أخرى.',
    'bossExport.savedPdf': 'تم حفظ PDF على جهازك.',
    'bossExport.savedExcel': 'تم حفظ Excel على جهازك.',
    'bossExport.sectionDaily': 'التفصيل اليومي',
    'bossExport.sectionSession': 'تفاصيل الجلسات',
    ...
    'feedbacks.successBanner': 'تم إرسال الملاحظات بنجاح!',
    ...
    'feedbacks.minLengthHint': 'الحد الأدنى 10 أحرف',
    ...
    'feedbacks.selectType': 'اختر النوع',
    'feedbacks.general': 'عام',
    'feedbacks.generalDesc': 'ملاحظات عامة واقتراحات أو تعليقات حول تجربتك',
    'feedbacks.bugReport': 'الإبلاغ عن مشكلة',
    'feedbacks.bugDesc': 'الإبلاغ عن خلل أو سلوك غير متوقع واجهته',
    'feedbacks.featureRequest': 'طلب ميزة',
    'feedbacks.featureDesc': 'اقتراح ميزة جديدة أو تحسين تود رؤيته',
    ...
    'backup.encryption': 'تخزين الجهاز',
    'backup.encryptionValue': 'OS-Managed',
