...
'backup.size': 'Size',
    ...
    'backup.storageNode': 'Storage Node',
    'backup.storageNodeValue': 'Local-First',
    'backup.neverBackedUp': 'Never backed up',
    'backup.encryptionType': 'Status',
    'backup.encryption': 'Device Encryption',
    'backup.encryptionValue': 'AES-256',
    'backup.footerNote': 'Your data remains exclusively under your custody. This process bundles your app state into a local package.',
    ...
    'restoreBackup.fileStatus': 'File Status',
    'restoreBackup.readyToImport': 'Ready to Import',
    'restoreBackup.targetArchive': 'Target Archive',
    'restoreBackup.fileSelectedSubtitle': 'Click to change selected backup',
    'restoreBackup.noFile': 'No File',
    'restoreBackup.selectBackupFile': 'Select a backup file to restore',
    'restoreBackup.staged': 'Staged',
    'restoreBackup.decompressRestoreState': 'Decompress & Restore State',
    'restoreBackup.browseExportFile': 'Browse Export File',
    'restoreBackup.warningText': 'Warning: restoring a backup may replace your current app data.',
    ...
    'timeclock.initializeTracking': 'Initialize live tracking workflow',
    'timeclock.activeSession': 'Active Session',
    'timeclock.sessionStatus': 'Session Status',
    'timeclock.sessionTime': 'Session Time',
    'timeclock.totalShift': 'Total shift',
    'timeclock.clickToFinish': 'Click to finish this tracking wave',
    'timeclock.endSessionTitle': 'End Current Active Session',
    'timeclock.endSessionSubtitle': 'Specify a checkout reason or type your own below.',
    'timeclock.customReasonLabel': 'Or write your own reason:',
    'timeclock.customReasonPlaceholder': 'Type your custom checkout reason here...',
  ...
  ar: {
    ...
    'timeclock.initializeTracking': 'بدء مسار التتبع المباشر',
    'timeclock.activeSession': 'جلسة نشطة',
    'timeclock.sessionStatus': 'حالة الجلسة',
    'timeclock.sessionTime': 'وقت الجلسة',
    'timeclock.totalShift': 'إجمالي الوردية',
    'timeclock.clickToFinish': 'انقر لإنهاء هذا المسار',
    'timeclock.endSessionTitle': 'إنهاء الجلسة النشطة الحالية',
    'timeclock.endSessionSubtitle': 'حدد سبب تسجيل الخروج أو اكتب السبب الخاص بك أدناه.',
    'timeclock.customReasonLabel': 'أو اكتب السبب الخاص بك:',
    'timeclock.customReasonPlaceholder': 'اكتب سبب تسجيل الخروج المخصص هنا...',
    ...
    'backup.storageNode': 'وحدة التخزين',
    'backup.storageNodeValue': 'محلي أولاً',
    'backup.neverBackedUp': 'لم يتم النسخ الاحتياطي من قبل',
    'backup.encryptionType': 'الحالة',
    'backup.encryption': 'تشفير الجهاز',
    'backup.encryptionValue': 'AES-256',
    'backup.footerNote': 'تظل بياناتك تحت حيازتك فقط. تقوم هذه العملية بتجميع حالة التطبيق في حزمة محلية.',
    ...
    'restoreBackup.fileStatus': 'حالة الملف',
    'restoreBackup.readyToImport': 'جاهز للاستيراد',
    'restoreBackup.targetArchive': 'الأرشيف المستهدف',
    'restoreBackup.noFile': 'لا يوجد ملف',
    'restoreBackup.selectBackupFile': 'اختر ملف نسخة احتياطية للاستعادة',
    'restoreBackup.fileSelectedSubtitle': 'انقر لتغيير الملف المحدد',
    'restoreBackup.staged': 'مُهيأ',
    'restoreBackup.decompressRestoreState': 'فك الضغط واستعادة الحالة',
    'restoreBackup.browseExportFile': 'استعراض ملف التصدير',
    'restoreBackup.warningText': 'تحذير: قد يؤدي استعادة نسخة احتياطية إلى استبدال بيانات التطبيق الحالية.',
